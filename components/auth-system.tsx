    ...
    return (
      <Card className="max-w-md mx-auto">
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-2xl font-serif font-bold mb-4">Account Created!</h3>
          <p className="text-muted-foreground mb-6">
            Welcome to our mental health support platform. You'll be logged in shortly.
          </p>
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-serif font-bold text-primary mb-2">MindCare</h1>
        <p className="text-muted-foreground">Your mental health support platform</p>
      </div>
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSignupData((prev) => ({ ...prev, institution: value }))}
                    required
                  >
                    <SelectTrigger>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Your data is encrypted and protected. We follow strict confidentiality guidelines for mental health
                  platforms.
                </p>
              </div>
            </div>
